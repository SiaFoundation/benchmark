...
require (
	...
	go.sia.tech/explored v1.0.0-beta.1.0.20250910211447-8db30cfcddc1 // indirect
	go.sia.tech/gofakes3 v0.0.5 // indirect
	go.sia.tech/hostd/v2 v2.4.2-0.20250910203220-667c1a1d97a7 // indirect
	go.sia.tech/jape v0.14.1 // indirect
	go.sia.tech/mux v1.4.0 // indirect
	go.sia.tech/walletd/v2 v2.10.5 // indirect
