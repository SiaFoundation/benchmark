...
require (
	...
	go.sia.tech/explored v1.0.0-beta.1.0.20250804133039-507ae8c4e819 // indirect
	go.sia.tech/gofakes3 v0.0.5 // indirect
	go.sia.tech/hostd/v2 v2.3.6-0.20250810180511-7435fe26eff5 // indirect
	go.sia.tech/jape v0.14.0 // indirect
	go.sia.tech/mux v1.4.0 // indirect
	go.sia.tech/walletd/v2 v2.10.5-0.20250805073250-f230faedfef2 // indirect
